      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <RadioGroup
            ...
            onValueChange={(value) => {
              updateSurveyData("visitPurpose", value);

              // If user selects Medicals (Occupational Health), automatically add the location
              if (value === "Medicals (Occupational Health)") {
                const ohLocation = "Occupational Health Unit (Medicals)";
                // Add to locations if not already there
                if (!surveyData.locations.includes(ohLocation)) {
                  updateSurveyData("locations", [
