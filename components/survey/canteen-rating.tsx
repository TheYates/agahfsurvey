...
export default function CanteenRating({ surveyData, updateSurveyData, onNext, onBack }: CanteenRatingProps) {
  ...
  const ratingCategories = [
    ...
    { id: "promptness-feedback", label: "Promptness of feedback - communicating delays, changes etc." },
