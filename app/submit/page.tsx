...
// Import the config explicitly to ensure it's included in the page
import "./config";
    ...
    <div className="container py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Please share your feedback about your recent visit to our hospital
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setFormData({ ...formData, visitTime: value as any })
                  }
                  className="mt-2"
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
                      ...
                      id="less-than-month"
                    />
                    <Label htmlFor="less-than-month">
                      Less than a month ago
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
                      value="one-two-months"
                      id="one-two-months"
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="more-than-six-months">
              ...
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setFormData({ ...formData, visitPurpose: value as any })
                  }
                  className="mt-2"
                >
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="occupational-health">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({
                      ...formData,
                      primaryLocation: Number.parseInt(value),
                    })
                  }
                >
                  ...
                  <SelectContent>
                    ...
                    {occupationalHealthLocations.length > 0 && (
                      <>
                        <SelectItem
                          value="occupational-health-header"
                          disabled
                          className="font-semibold"
                        >
                          Occupational Health
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setFormData({ ...formData, visitedOtherPlaces: !!checked })
                  }
                />
                <Label htmlFor="visitedOtherPlaces">
                  I visited other locations during my visit
                </Label>
              </div>
            </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        whyNotRecommend: e.target.value,
                      })
                    }
                    className="mt-2"
                  />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="corporate-employee">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="contractor-employee">
                      Contractor Employee
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setFormData({ ...formData, patientType: value as any })
                  }
                  className="mt-2"
                >
                  <div className="flex items-center space-x-2">
